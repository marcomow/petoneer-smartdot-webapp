...
})({"5T65z":[function(require,module,exports) {
...
var _buttonBtConnect = require("./custom_elements/ButtonBtConnect");
var _sectionInteractions = require("./custom_elements/SectionInteractions");
const init = ()=>{
    const main = document.querySelector('main');
    main.appendChild(document.createElement('div', {
        is: _sectionInteractions.SectionInteractions.tag
    }));
    main.appendChild(document.createElement('button', {
        is: _buttonBtConnect.ButtonBtConnect.tag
    }));
};
init();

},{"./custom_elements/SectionInteractions":"kJzhS","./custom_elements/ButtonBtConnect":"gqsFP"}],"kJzhS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SectionInteractions", ()=>SectionInteractions
);
var _btController = require("./BtController");
var _buttonSendPreset = require("./ButtonSendPreset");
var _hasIs = require("./hasIs");
class SectionInteractions extends HTMLDivElement {
    static get tag() {
    ...
    refreshButtons(show) {
        ...
        const commands = [
            {
                command: '0f0405000107',
                title: 'small'
            },
            {
                command: '0f0405000208',
                title: 'medium'
            },
            {
                command: '0f0405000309',
                title: 'large'
            }
        ];
        const buttonsPreset = commands.map((command)=>{
            const button = document.createElement('button', {
                is: _buttonSendPreset.ButtonSendPreset.tag
            });
            button.setAttribute(_buttonSendPreset.btCommandAttribute, command.command);
            button.innerHTML = command.title;
            button.addEventListener('click', ()=>{
                _btController.btController.setPresetCommand(command.command);
            });
            this.append(button);
            return button;
        });
...
customElements.define(SectionInteractions.tag, SectionInteractions, {
    extends: 'div'
});

},{"./ButtonSendPreset":"c7ktJ","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","./hasIs":"2FSrY","./BtController":"et3H5"}],"c7ktJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "btCommandAttribute", ()=>btCommandAttribute
);
parcelHelpers.export(exports, "ButtonSendPreset", ()=>ButtonSendPreset
);
const btCommandAttribute = 'bt-command';
class ButtonSendPreset extends HTMLButtonElement {
    static get tag() {
        return `button-send-preset`;
    }
    connectedCallback() {
        const presetCommand = this.getAttribute(btCommandAttribute);
        if (!presetCommand) throw `Attribute '${btCommandAttribute}' was not set.`;
    }
}
customElements.define(ButtonSendPreset.tag, ButtonSendPreset, {
    extends: `button`
});
...
},{}],"2FSrY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "hasIs", ()=>hasIs
);
const hasIs = (element)=>{
    element.setAttribute("is", element.constructor["tag"]);
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"et3H5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "btController", ()=>btController
);
var _sweetalert2 = require("sweetalert2");
var _sweetalert2Default = parcelHelpers.interopDefault(_sweetalert2);
var _buttonBtConnect = require("./ButtonBtConnect");
class BtController {
    async connect() {
        if (!navigator.bluetooth) {
            _sweetalert2Default.default.fire({
                title: `The bluetooth platform is not available on this device.`
            });
            return false;
        }
        if (!navigator.bluetooth.getAvailability()) {
            _sweetalert2Default.default.fire({
                title: `Bluetooth not available, disconnect from other devices first.`
            });
            return false;
        }
        try {
            ...
            this.device.ongattserverdisconnected = ()=>{
                const buttonBtConnect = document.querySelector(`[is="${_buttonBtConnect.ButtonBtConnect.tag}"]`);
    ...
    async setPresetCommand(command) {
        const service = await this.server.getPrimaryService(65520);
        const characteristic = await service.getCharacteristic(65523);
...
},{"sweetalert2":"a6ulr","./ButtonBtConnect":"gqsFP","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"a6ulr":[function(require,module,exports) {
...
},{}],"gqsFP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ButtonBtConnect", ()=>ButtonBtConnect
);
var _sectionInteractions = require("./SectionInteractions");
var _hasIs = require("./hasIs");
var _btController = require("./BtController");
class ButtonBtConnect extends HTMLButtonElement {
    static get tag() {
        return `button-bt-connect`;
    }
    set connected(isConnected) {
        this.disabled = isConnected;
        const sectionInteractions = document.querySelector(`[is="${_sectionInteractions.SectionInteractions.tag}"]`);
    ...
    connectedCallback() {
        ...
        this.addEventListener('click', async ()=>{
            this.disabled = true;
            const isConnected = await _btController.btController.connect();
            this.connected = isConnected;
        });
    }
}
customElements.define(ButtonBtConnect.tag, ButtonBtConnect, {
    extends: 'button'
});

},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","./hasIs":"2FSrY","./BtController":"et3H5","./SectionInteractions":"kJzhS"}]},["5T65z","4aleK"], "4aleK", "parcelRequirec9bc")
